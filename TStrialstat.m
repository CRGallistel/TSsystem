% TSTRIALSTAT  Compute within-trial statistics
%   ER = TSTRIALSTAT(STATNAME,FUNHAND,VARARGIN) creates a stat called STATNAME
...
%   and the remaining arguments given in VARARGIN. Privileged words that
%   may be used in the string are: StartTime
%
%   Any functions written for use with TSTRIALSTAT must take TSDATA as its
%   first argument.  Any other arguments will come from VARARGIN.
%
...
function ER=TStrialstat(stat, funhand, varargin)
